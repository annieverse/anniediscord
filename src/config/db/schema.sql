...
--
-- Name: user_trade_log; Type: TABLE; Schema: public; Owner: annie
--
...
ALTER TABLE public.user_trade_log OWNER TO annie;

--
-- Name: user_trade_log_trade_id_seq; Type: SEQUENCE; Schema: public; Owner: annie
--
...
--
-- Name: user_trade_log user_trade_log_pkey; Type: CONSTRAINT; Schema: public; Owner: annie
--

ALTER TABLE ONLY public.user_trade_log
    ADD CONSTRAINT user_trade_log_pkey PRIMARY KEY (trade_id);


--
-- Name: idx_user_trade_log_guild; Type: INDEX; Schema: public; Owner: annie
--

CREATE INDEX idx_user_trade_log_guild ON public.user_trade_log USING btree (guild_id, registered_at DESC);


--
-- Name: idx_user_trade_log_user_a; Type: INDEX; Schema: public; Owner: annie
--

CREATE INDEX idx_user_trade_log_user_a ON public.user_trade_log USING btree (user_a_id, registered_at DESC);


--
-- Name: idx_user_trade_log_user_b; Type: INDEX; Schema: public; Owner: annie
--

CREATE INDEX idx_user_trade_log_user_b ON public.user_trade_log USING btree (user_b_id, registered_at DESC);
