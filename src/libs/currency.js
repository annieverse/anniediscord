...
class Currency extends Points {
    ...
    execute() {
    	...
    	this.db.databaseUtility.updateInventory({itemId: 52, value: this.totalGainedCurrency, operation: `+`, userId: this.message.author.id, guildId: this.message.guild.id})
