...
module.exports = {
    ...
    async minus(client, reply, message, arg, locale, prefix) {
        ...
        c.onAccept(async () => {
            ...
            client.db.userUtility.updateUserExp(amountToSubtract, targetUser.master.id, message.guild.id, `-`)
            await reply.send(``, {
    ...
    async reset(client, reply, message, arg, locale, prefix) {
        ...
        c.onAccept(async () => {
            expLib.updateRank(0)
            client.db.userUtility.resetUserExp(targetUser.master.id, message.guild.id)
            await reply.send(``, {
