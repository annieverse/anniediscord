...
module.exports = {
  ...
  async autocomplete(client, interaction) {
    ...
    const choices = Object.keys(client.localization.availableLocales)
    ...
    await interaction.respond(
      filtered.map(choice => ({ name: capitalizeFirstLetter(choice), value: client.localization.availableLocales[choice] })),
    )
  },
