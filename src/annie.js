    ...
    constructor(intents) {
        super({
            intents: intents, presence: { status: `idle`, activities: [{ name: `Shard preparing ...`, type: Discord.ActivityType.Watching }] }, makeCache: Discord.Options.cacheWithLimits({
                ...
                // Set all endpoints below to default until we understand them more
                MessageManager: Discord.Options.createDefault(), // This will affect the reactions on a message
